...
export const tasksApi = {
    ...
    addSubtask: (boardId, taskId, subtaskData) => axiosInstance.post(`boards/${boardId}/tasks/${taskId}/subtasks`, subtaskData),
    deleteSubtask: (boardId, taskId, subtaskId) => axiosInstance.delete(`boards/${boardId}/tasks/${taskId}/subtasks/${subtaskId}`),
    updateSubtask: (boardId, taskId, subtaskId, subtaskData) => axiosInstance.patch(`boards/${boardId}/tasks/${taskId}/subtasks/${subtaskId}`, subtaskData),
