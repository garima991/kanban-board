  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center mb-11 gap-4">
        ...
        <motion.div
          id="demo"
          className="w-full max-w-5xl mb-20 aspect-video bg-gray-50 rounded-xl shadow-inner flex items-center justify-center text-gray-600 text-lg"
          initial={{ scale: 0.95, opacity: 0 }}
          whileInView={{ scale: 1, opacity: 1 }}
          transition={{ delay: 0.2, duration: 0.8 }}
          viewport={{ once: true }}
        >
          <div className="mt-10 z-20">Demo video</div>
        </motion.div>
